...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), [os.path.join('launch', 'sensor_fusion.py')]),
    ...
    entry_points={
        'console_scripts': [
            ...
            'proximity_to_laserscan_node = go2_robot_sdk.presentation.proximity_to_laserscan_node:main',
            'detection_navigator_node = go2_robot_sdk.presentation.detection_navigator_node:main',
        ],
    },
)
